...
ROOT_CONTEXT = (
    ...
    "latest Markdown traversal receipt. For covered product work, reopen the "
    "recorded Markdown path, check node and contract revisions for drift, and re-read the pinned "
    ...
    "siblings merely because context was compacted. State the Markdown path, contracts, "
...
WORKER_CONTEXT = (
    ...
    "applicable AGENTS.md layer, then read the finite worker packet, Markdown "
    "traversal receipt, and every contract in its pinned closure. Verify linked revisions "
    ...
    "Markdown path, or contract is missing or drifted, stop with that exact dependency "
    ...
    "State the linked contracts read in the first progress update and keep "
