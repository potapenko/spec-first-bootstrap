...
| --- | --- | --- | --- | --- |
| [Bootstrap governance](features/bootstrap-governance.md) | Active | Accepted | `bootstrap.governance@10` | Setup, governance, Markdown routing, prompts, templates, scope, or proportionality |
