...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [`features/bootstrap-governance.md`](features/bootstrap-governance.md) | `bootstrap.governance` | Active | Accepted | `bootstrap.governance@1` | Changing setup scope, governance, prompts, templates, or layer composition | Governs all Bootstrap installation surfaces | `ba891245af7ffa6ffa5463f85af8045b3f6bc75c` |
