...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [`features/bootstrap-governance.md`](features/bootstrap-governance.md) | `bootstrap.governance` | Active | Evolving | `bootstrap.governance@2` | Changing setup scope, governance, prompts, templates, layer composition, or outcome/resource proportionality | Governs all Bootstrap installation surfaces | `ba891245af7ffa6ffa5463f85af8045b3f6bc75c` |
